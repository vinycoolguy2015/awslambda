...
resource "aws_launch_configuration" "web" {
  ...
  security_groups = [data.terraform_remote_state.vpc.outputs.instance_security_group]
...
resource "aws_lb" "web" {
  ...
  security_groups    = [data.terraform_remote_state.vpc.outputs.lb_security_group]
