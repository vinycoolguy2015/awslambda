...
def lambda_handler(event, context):
    ...
    for item in inbox.all().order_by('-datetime_received'):
        ...
        msg["X-SES-CONFIGURATION-SET"] = "ses-configuration-set"
        ...
        try:
            ...
            print("Successfully forwarded email received from "+item.sender.email_address)
            #server.close()
        except Exception as ex:
            print("Failed to forward email received from "+item.sender.email_address)
            print(ex)
